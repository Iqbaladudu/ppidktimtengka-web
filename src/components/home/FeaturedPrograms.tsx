...
const programs: Program[] = [
  {
    id: 'career-talk',
    title: 'Career Talk & Job Fair',
    emoji: '💼',
    category: 'Karir',
    description:
      'Platform eksklusif yang menghubungkan mahasiswa Timur Tengah & Afrika dengan perusahaan multinasional dan BUMN.',
    schedule: 'Tahunan (Oktober)',
  ...
  },
  {
    ...
    category: 'Evaluasi',
    description:
      'Forum terbuka survei dan evaluasi program kerja untuk peningkatan kualitas layanan organisasi secara berkelanjutan.',
    schedule: 'Triwulan',
  ...
  {
    id: 'timtengka-awards',
    title: 'TIMTENGKA Awards',
    emoji: '🏆',
    category: 'Penghargaan',
    description:
      'Ajang apresiasi tertinggi bagi PPI Negara dan individu berprestasi yang telah mengharumkan nama bangsa.',
  ...
  {
    id: 'goks',
    title: 'GOKS (Gerakan Optimal Kaderisasi)',
    emoji: '🔥',
    category: 'Kaderisasi',
    description:
      'Kurikulum pengkaderan terintegrasi untuk mencetak pemimpin masa depan yang berkarakter dan kompeten.',
    schedule: 'Tahunan',
  ...
  {
    id: 'circle',
    title: 'Circle TIMTENGKA',
    emoji: '🎯',
    category: 'Minat Bakat',
    description:
      'Komunitas hobi spesifik (Fotografi, Desain, E-Sport) untuk menyalurkan bakat dan kolaborasi karya.',
    schedule: 'Mingguan',
    color: 'from-pink-500 to-rose-600',
  },
  {
    id: 'omon-omon',
    title: 'Omon-Omon Bareng',
    emoji: '💬',
    category: 'Literasi',
    description:
      'Ruang dialektika santai namun berbobot membahas isu-isu strategis kawasan dan global.',
    schedule: 'Bulanan',
  ...
  {
    id: 'pesilat',
    title: 'Pesilat TIMTENGKA',
    emoji: '🕌',
    category: 'Keagamaan',
    description:
      'Pesantren Kilat Online di bulan Ramadhan untuk penguatan spiritual dan kajian keislaman moderat.',
    schedule: 'Ramadhan',
  ...
  {
    id: 'info-a1',
    title: 'Info A1 Blak-Blakan',
    emoji: '📢',
    category: 'Informasi',
    description:
      'Sesi tanya jawab langsung seputar perkuliahan dan beasiswa di berbagai negara Timur Tengah & Afrika.',
  ...
  },
  {
    ...
    category: 'Networking',
    description:
      'Jembatan silaturahmi dan mentorship antara mahasiswa aktif dengan alumni sukses di berbagai sektor.',
    schedule: 'Semester',
    color: 'from-slate-500 to-slate-600',
  },
  {
    id: 'gercep',
    title: 'Gercep (Gerak Cepat)',
    emoji: '🚨',
    category: 'Sosial',
    description:
      'Unit reaksi cepat tanggap bencana dan aksi sosial kemanusiaan untuk masyarakat yang membutuhkan.',
    schedule: 'Insidental',
...
export const FeaturedPrograms: React.FC = React.memo(() => {
            ...
            >
              ...
              <div className="p-5 lg:p-6 flex-1 flex flex-col">
                ...
                <div className="pt-4 border-t border-slate-100 dark:border-slate-800 mt-auto">
                  <button className="flex items-center gap-2 text-xs lg:text-sm font-bold text-slate-700 dark:text-slate-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                    Lihat Detail
