      ...
      >
        <div className="mx-auto max-w-[1440px] flex h-16 lg:h-20 items-center justify-between px-4 lg:px-8">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="flex h-10 w-10 lg:h-12 lg:w-12 items-center justify-center rounded-xl bg-primary text-primary-foreground font-bold text-lg lg:text-xl shadow-lg shadow-primary/25 transition-transform group-hover:scale-105">
              P
            </div>
                ...
                <Link
                  ...
                  className={`flex items-center gap-1 px-4 py-2 text-sm font-medium rounded-lg transition-all ${
                    activeDropdown === item.label
                      ...
                      : 'text-muted-foreground hover:text-primary dark:hover:text-primary-foreground hover:bg-muted dark:hover:bg-muted/50'
                  }`}
                >
                  {item.label}
                  {item.children && (
                    ...
                    <div className="w-64 rounded-xl bg-white dark:bg-slate-900 shadow-xl border border-slate-200/60 dark:border-slate-800/60 overflow-hidden">
                      {item.children.map((child) => (
                        <Link
                          key={child.label}
                          href={child.href}
                          className="block px-4 py-3 hover:bg-muted dark:hover:bg-muted/50 transition-colors group"
                        >
                          <span className="text-sm font-medium text-foreground group-hover:text-primary dark:group-hover:text-primary-foreground">
                            {child.label}
                          </span>
                          {child.description && (
          ...
          <div className="flex items-center gap-2 lg:gap-3">
            {/* Search */}
            <button
              className="hidden md:flex h-10 w-10 items-center justify-center rounded-lg text-muted-foreground hover:text-primary dark:hover:text-primary-foreground hover:bg-muted dark:hover:bg-muted/50 transition-all"
              aria-label="Search"
            >
            ...
            {/* Language Switcher */}
            <button
              className="hidden md:flex items-center gap-1 h-10 px-3 rounded-lg text-sm font-medium text-muted-foreground hover:text-primary dark:hover:text-primary-foreground hover:bg-muted dark:hover:bg-muted/50 transition-all"
              aria-label="Language"
            >
            ...
            <Link
              href="/contact"
              className="hidden md:inline-flex h-10 lg:h-11 items-center justify-center gap-2 rounded-full bg-primary px-5 lg:px-6 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/25 transition-all hover:shadow-xl hover:shadow-primary/30 hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            <button
              ...
              className="lg:hidden flex h-10 w-10 items-center justify-center rounded-lg text-muted-foreground hover:bg-muted dark:hover:bg-muted/50 transition-all"
          ...
          <div className="absolute top-16 left-0 right-0 max-h-[calc(100vh-4rem)] overflow-y-auto bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-xl">
            ...
            <div className="px-4 pb-6 pt-2 border-t border-slate-100 dark:border-slate-800">
              <Link
                href="/contact"
                onClick={() => setIsMobileMenuOpen(false)}
                className="flex items-center justify-center gap-2 w-full h-12 rounded-xl bg-primary text-base font-semibold text-primary-foreground shadow-lg"
              >
