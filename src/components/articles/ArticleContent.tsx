  ...
  return (
    <div
      className={cn(
        ...
        'md:prose-lg', // Larger text only on desktop
        // Headings
        ...
        'prose-h2:text-2xl md:prose-h2:text-3xl prose-h2:mt-10 md:prose-h2:mt-12 prose-h2:mb-4 md:prose-h2:mb-6 prose-h2:border-b prose-h2:pb-2',
        ...
        'prose-figcaption:mt-2 md:prose-figcaption:mt-3 prose-figcaption:text-center prose-figcaption:text-xs md:prose-figcaption:text-sm prose-figcaption:text-slate-500 prose-figcaption:font-sans',
        // Tables
        'prose-table:border prose-th:bg-slate-50 prose-th:p-3 md:prose-th:p-4 prose-td:p-3 md:prose-td:p-4 prose-td:border-slate-100 prose-table:text-sm md:prose-table:text-base',
        className,
      )}
    >
